    ...
    return (
        <div className="navbar bg-base-100 px-6 py-4">
            <div className="navbar-start">
                ...
                <Link to='/' className="btn btn-ghost normal-case text-3xl font-bold text-green-500 font-serif">Health Coach</Link>
            </div>
            ...
            <div className="navbar-end">
                <Link to='' className="btn bg-green-500  border-none">Get started</Link>
            </div>
        </div>
    );
};
