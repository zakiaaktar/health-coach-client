					...
					<div className='mt-8 items-center justify-center sm:flex'>
						...
						<div className='mt-6 sm:mt-0'>
							<ul className='flex items-center justify-center space-x-4'>
								...
								<li className='w-10 h-10 border-2 border-red-500 rounded-full flex items-center justify-center'>
									<Link to='/'>
										<svg className='svg-icon w-6 h-6 text-red-500' viewBox='0 0 20 20'>
											<path
												fill='none'
